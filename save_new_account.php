    ...
    VALUES ('$fname', '$lname', '$email', '$contact_num', '$username', '$final_pass', 'Student', 'User', '$v_code', 'Pending')";
    $conn->exec($saveNewUser);
    
    $saveNewStudent = "INSERT INTO students(fname, lname, contact_num, email, v_code)VALUES('$fname', '$lname', '$contact_num', '$email', '$v_code')";
    ...
    <strong>Password: '.$password.'</strong><br /><br /><br />
