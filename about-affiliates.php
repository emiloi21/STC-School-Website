          ...
          <div class="row d-flex align-items-center flex-wrap">
            ...
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                ...
                <li class="breadcrumb-item active" style="color: #075907;">ACCREDITATION &amp; AFFILIATIONS</li>
              </ul>
            </div>
          </div>
        </div>
              ...
              <div class="panel panel-default sidebar-menu with-icons">
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    ...
                    <li class="nav-item"><a style="color: #e5eb0b;" href="#" class="nav-link active">ACCREDITATION &amp; AFFILIATIONS</a></li>
            ...
            <div class="col-lg-9">
                <div class="row">
                  ...
                  <div class="row portfolio text-center">
                    ...
                    <?php
                    $subjK_query = $conn->query("SELECT * FROM tbl_accred_affiliate ORDER BY accred_affil_id ASC") or die(mysql_error());
                        ...
                        <div class="box-image">
                          <div class="image"><img src="admin/<?php echo $subjK_row['img']; ?>" alt="" class="img-fluid">
                            <div class="overlay d-flex align-items-center justify-content-center">
                              <div class="content">
                                <div class="name">
                                  <h3><a href="#" data-toggle="modal" data-target="#facility-modal<?php echo $accred_affil_id; ?>" class="color-white"><?php echo $subjK_row['title'];; ?></a></h3>
                                </div>
                                <div class="text">
                                  <!--p class="d-none d-sm-block">some text...</p-->
                                  <p class="buttons"><a href="#" data-toggle="modal" data-target="#facility-modal<?php echo $accred_affil_id; ?>" class="btn btn-template-outlined-white">Read more</a></p>
                                </div>
                              </div>
                            </div>
                          </div>
                    ...
                    ?>
                      ...
                      <!-- Facility Modal-->
                      <div id="facility-modal<?php echo $accred_affil_id; ?>" tabindex="-1" role="dialog" aria-labelledby="login-modalLabel" aria-hidden="true" class="modal fade">
