...
<html>
  ...
  <head>
    ...
    <title>BCCNIANS WEB Portal</title>
  ...
  <body>
            ...
            <tr>
                ...
                <p style="margin-top: 0px; font-size: 14px;"><strong>COLLEGE DEPARTMENT</strong></p>
                </center>
                </td>
            </tr>
            ...
            <tr>
            <td><?php echo $studData_row['col_last_school']; ?></td>
            <td><?php echo $studData_row['col_last_school_sy']; ?></td>
            <td><?php echo $studData_row['col_last_school_address']; ?></td>
            <td><?php echo $studData_row['col_last_school_type']; ?> - College</td>
            </tr>
            <?php } ?>
            
            <tr>
            <td><?php echo $studData_row['shs_last_school']; ?></td>
            <td><?php echo $studData_row['shs_last_school_sy']; ?></td>
            <td><?php echo $studData_row['shs_last_school_address']; ?></td>
            <td><?php echo $studData_row['shs_last_school_type']; ?> - Senior High</td>
            </tr>
