                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <p>ELEMENTARY SCHOOL</p>
                        <div class="row">
                          <div class="col-md-9">
                             <input value="<?php echo $studData_row['elem_last_school']; ?>" name="elem_last_school" list="search_elem_last_school" class="form-control form-control-sm" placeholder="Name of school" required="" />
                    ...
                    <div class="form-group row">
                      ...
                      <p>JUNIOR SCHOOL</p>
                        <div class="row">
                          <div class="col-md-9">
                             <input value="<?php echo $studData_row['jhs_last_school']; ?>" name="jhs_last_school" list="search_jhs_last_school" class="form-control form-control-sm" placeholder="Name of school" required="" />
                    ...
                    <div class="form-group row">
                      ...
                      <p>SENIOR HIGH SCHOOL</p>
                        <div class="row">
                          <div class="col-md-9">
                             <input value="<?php echo $studData_row['shs_last_school']; ?>" name="shs_last_school" list="search_shs_last_school" class="form-control form-control-sm" placeholder="Name of school" required="" />
                    ...
                    <div class="form-group row">
                      ...
                      <p>COLLEGE <small>(If Transferee)</small></p>
                        <div class="row">
                          ...
                          <div class="col-md-9">
                             <input value="<?php echo $studData_row['col_last_school_address']; ?>" name="col_last_school_address" list="search_col_last_school_address" class="form-control form-control-sm" required="" />
