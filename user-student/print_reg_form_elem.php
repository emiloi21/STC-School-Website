...
<html>
  ...
  <body>
            ...
            <tr>
                ...
                <p style="margin-top: 0px; font-size: 14px;"><strong>GRADE SCHOOL LEVEL</strong></p>
                </center>
                </td>
            </tr>
            ...
            <?php } ?>
            <tr>
            <td><?php echo $studData_row['last_school']; ?></td>
            <td><?php echo $studData_row['last_school_sy']; ?></td>
            <td><?php echo $studData_row['last_school_address']; ?></td>
            <td><?php echo $studData_row['last_school_type']; ?> - Pre-School</td>
            </tr>
