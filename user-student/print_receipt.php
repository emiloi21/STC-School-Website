...
<tr>
    ...
    <td style="border: none;">
    <center>
    <p style="margin: 2px; font-size: 14px;"><strong>ACKNOWLEDGEMENT RECEIPT</strong></p>
...
<tr>
<td style="font-weight: lighter; width: 50%;">AR #: <strong style="font-size: 14px;"><?php echo $_GET['receipt_num']; ?></strong></td>
