                    ...
                    <div class="form-group row">
                      <div class="col-sm-12">
                        <div class="row">
                          ...
                          <div class="col-md-3">
                             <input value="<?php echo $studData_row['email']; ?>" name="email" class="form-control form-control-sm" readonly="" required="" />
                    ...
                    <div class="form-group row">
                      <div class="col-sm-12">
                        ...
                        <div class="line"></div>
                          ...
                          <div class="col-md-12">
                             <input value="<?php echo $studData_row['parents_email']; ?>" type="email" name="parents_email" class="form-control form-control-sm" placeholder="Enter parent's email address" required="" />
