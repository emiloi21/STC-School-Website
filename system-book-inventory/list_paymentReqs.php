            ...
            <?php include('add_payValid_modal.php'); ?>
                ...
                <hr />
                    <table id="" class="display" style="width:100%">
                      ...
                      ?>
                      <a class="btn btn-info btn-sm" title="Print receipt..." href="print_receipt_books.php?receipt_num=<?php echo $trans_row['receipt_num']; ?>&report_type=AR" target="_blank" style="margin-bottom: 4px;"><i class="fa fa-print"></i></a>
