      ...
      <div class="breadcrumb-holder">
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="list_applicants.php?dept=<?php echo $studData_row['dept']; ?>&gradeLevel=<?php echo $studData_row['gradeLevel']; ?>&strand=<?php echo $studData_row['strand']; ?>&major=<?php echo $studData_row['major']; ?>">Admission Applicants</a></li>
            <li class="breadcrumb-item active">Student Applicant Details</li>
             ...
             <!-- kinder 1     -->
              <div id="new-updates" class="card updates recent-updated">
                ...
                <div class="tab" style="margin-top: 8px;">
                  <a class="tablinks" onclick="openCity(event, 'London')">Student Profile</a>
                  <a class="tablinks active" onclick="openCity(event, 'Paris')">Requirements</a>
                </div>
                 
                 
                <div id="London" class="tabcontent">
                    
                    <?php include('stud_details_app.php'); ?>
                ...
                <div class="table-responsive" style="margin-top: 12px;">
                        ...
                        <table id="" class="display" style="width:100%">
                          ...
                          <center>
                          <img id="theImage<?php echo $reqStud_row['require_id']; ?>" src="<?php echo '../user-student/'.$reqStud_row['img']; ?>" style="width: 100px; height: 100px; display: block; cursor: pointer;" title="Click to view full screen..." class="fullscreen" onclick="makeFullScreen<?php echo $reqStud_row['require_id']; ?>()" />
                          ...
                          <td>
                            ...
                            <a class="btn btn-success btn-sm" title="Download file..." href="../user-student/<?php echo $reqStud_row['img']; ?>" style="margin-bottom: 4px; color: white;" download><i class="fa fa-download"></i></a>
                          </td>
                          ...
                          <div id="viewFile<?php echo $reqStud_row['stud_reqs_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                            <div role="document" class="modal-dialog">
                              <div class="modal-content">
                                <form action="save_requirements_validation_app.php?dept=<?php echo $_GET['dept']; ?>&regx_id=<?php echo $_GET['regx_id']; ?>&stud_reqs_id=<?php echo $reqStud_row['stud_reqs_id']; ?>" method="POST">
