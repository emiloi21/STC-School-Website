          ...
          <div class="row">
            <div class="col-lg-12 col-md-12">
              ...
              <div id="new-updates" class="card updates recent-updated">
                ...
                ?>
                <form action="save_add_student.php?dept=<?php echo $_GET['dept']; ?>&student_id=<?php echo $_GET['student_id']; ?>" method="POST">
                ...
                <div class="pull-right">
                      <a href="home.php" class="btn btn-secondary" style="margin-right: 8px; color: white;">Cancel</a>
                      <button name="addStudent_accPayable" type="submit" class="btn btn-primary">Save</button>
                </div>
                </div>
