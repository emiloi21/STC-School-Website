    ...
    <!-- UPDATE STUDENT INFORMATION - ENROLLED -->
    ...
    window.location='list_stud_details.php?dept=<?php echo $_GET['dept']; ?>&regx_id=<?php echo $_GET['regx_id']; ?>&class_id=<?php echo $_GET['class_id']; ?>';
    </script>
    
    <?php }  ?>
    <!-- END UPDATE STUDENT INFORMATION - ENROLLED -->
