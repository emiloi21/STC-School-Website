      ...
      <div class="breadcrumb-holder">
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="list_applicants.php?dept=<?php echo $_GET['dept']; ?>&gradeLevel=&strand=&major=&status=<?php echo $_GET['status']; ?>">Admission Applicants</a></li>
             ...
             <!-- kinder 1     -->
              <div id="new-updates" class="card updates recent-updated">
                ...
                <div id="London" class="tabcontent" style="display: block;">
                    ...
                    if($_GET['dept']==='Grade School'){
                        include('stud_details_app_gradeSchool.php');
                        
                    }elseif($_GET['dept']==='Junior High School'){
                        include('stud_details_app_JHS.php');
                        
                    }elseif($_GET['dept']==='Senior High School'){
                        include('stud_details_app_SHS.php');
                        
                    }elseif($_GET['dept']==='College'){
                        include('stud_details_app_college.php');
                    }
