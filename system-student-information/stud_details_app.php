                      <div class="row">
                      <form action="save_student_profile_applicants.php?dept=<?php echo $_GET['dept']; ?>&regx_id=<?php echo $_GET['regx_id']; ?>&class_id=<?php echo $_GET['class_id']; ?>" method="POST" class="col-lg-12">
                        <div class="col-lg-12">
                          <div class="card">
