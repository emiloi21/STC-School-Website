...
<html>
  ...
  <?php include('menu_sidebar.php'); ?>
    ...
    <!-- Breadcrumb-->
      <div class="breadcrumb-holder">
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="list_students.php?dept=<?php echo $_GET['dept']; ?>&class_id=<?php echo $_GET['class_id']; ?>">List of Students</a></li>
      ...
      <section class="forms">
        <div class="container-fluid">
          ...
          <div class="row">
          <form action="save_add_student.php?dept=<?php echo $_GET['dept']; ?>&regx_id=<?php echo $_GET['regx_id']; ?>&class_id=<?php echo $_GET['class_id']; ?>" method="POST" class="col-lg-12">
            <div class="col-lg-12">
              <div class="card">
              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <a href="list_students.php?dept=<?php echo $_GET['dept']; ?>&class_id=<?php echo $_GET['class_id']; ?>" class="btn btn-secondary">Cancel</a>
              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                      <div class="col-12 text-center">
                      <a href="list_students.php?dept=<?php echo $_GET['dept']; ?>&class_id=<?php echo $_GET['class_id']; ?>" class="btn btn-secondary">Cancel</a>
                      <button name="updateInfoJHS" type="submit" class="btn btn-primary">Save changes</button>
                      </div>
                    </div>
                </div>
              </div>
      ...
      <section class="forms">
        <div class="container-fluid">
          ...
          <header> 
            <h1 class="h3 display">S.Y. <?php echo $data_src_sy; ?> - <?php echo $data_src_sem; ?> <small>( <?php echo $studData_row['classification']; ?> )</small></h1>
            <h1 class="h5 display">LRN: <strong><?php echo $studData_row['lrn']; ?></strong> &middot; ID Code: <strong><?php echo $studData_row['student_id']; ?></strong></h1>
            <h1 class="h6 display">ESC Status: <strong><?php echo $studData_row['escGrantee']; ?></strong></h1>
          </header>
          <div class="row">
          <form action="save_add_student.php?dept=<?php echo $_GET['dept']; ?>&regx_id=<?php echo $_GET['regx_id']; ?>&class_id=<?php echo $_GET['class_id']; ?>" method="POST" class="col-lg-12">
            <div class="col-lg-12">
              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                      <div class="col-12 text-center">
                      <a href="list_students.php?dept=<?php echo $_GET['dept']; ?>&class_id=<?php echo $_GET['class_id']; ?>" class="btn btn-secondary">Cancel</a>
                      <button name="updateInfoSHS" type="submit" class="btn btn-primary">Save changes</button>
                      </div>
                    </div>
                </div>
              </div>
      ...
      <section class="forms">
        <div class="container-fluid">
          ...
          <header> 
            <h1 class="h3 display">S.Y. <?php echo $data_src_sy; ?> - <?php echo $data_src_sem; ?> <small>( <?php echo $studData_row['classification']; ?> )</small></h1>
            <h1 class="h5 display">ID Code: <strong><?php echo $studData_row['student_id']; ?></strong></h1>
          </header>
          <div class="row">
          <form action="save_add_student.php?dept=<?php echo $_GET['dept']; ?>&regx_id=<?php echo $_GET['regx_id']; ?>&class_id=<?php echo $_GET['class_id']; ?>" method="POST" class="col-lg-12">
            <div class="col-lg-12">
              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                      <div class="col-12 text-center">
                      <a href="list_students.php?dept=<?php echo $_GET['dept']; ?>&class_id=<?php echo $_GET['class_id']; ?>" class="btn btn-secondary">Cancel</a>
                      <button name="updateInfoCol" type="submit" class="btn btn-primary">Save changes</button>
                      </div>
                    </div>
                </div>
              </div>
    ...
    function close_window() {
      if (confirm("Changes made won't be saved, Do you want to close window?")) {
        close();
      }
    }
    </script>
