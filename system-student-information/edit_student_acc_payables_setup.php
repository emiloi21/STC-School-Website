      ...
      <div class="breadcrumb-holder">
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Set Student Assessment</li>
          </ul>
        </div>
      </div>
            ...
            <div class="col-lg-12 col-md-12">
              ...
              <div id="new-updates" class="card updates recent-updated">
                <div id="updates-header" class="card-header d-flex justify-content-between align-items-center">
                  <h2 class="h5 display">
                  <a data-toggle="collapse" data-parent="#new-updates" href="#updates-boxKinder" aria-expanded="true" aria-controls="updates-boxKinder"><strong style="font-weight: bold !important;">SET STUDENT ASSESSMENT</strong></a>
                ...
                ?>
                <form action="save_add_student.php?dept=<?php echo $_GET['dept']; ?>&class_id=<?php echo $_GET['class_id']; ?>&student_id=<?php echo $_GET['student_id']; ?>" method="POST">
                ...
                <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <small class="form-text">PEAC-FAPE Subsidy</small>
                                  </div>
                                  ...
                                  <?php } ?>
                                    ...
                                    <?php if($studInfo_row['assessment_id']>0){ ?>
                                    
                                    <?php
                                    
                                    $tblAcctAssess_query = $conn->query("SELECT assessment_id, description FROM tbl_accounts_assessments WHERE assessment_id='$studInfo_row[assessment_id]'") or die(mysql_error());
                                    $tbl_AA_row = $tblAcctAssess_query->fetch(); ?>
                                    
                                    <option value="<?php echo $tbl_AA_row['assessment_id']; ?>"><?php echo $tbl_AA_row['description']; ?></option>
                                
                                    <?php }else{ ?>
                                    
                                        <option value="0">--Select Assessment Group--</option>
                                    <?php } ?>
                ...
                <div class="pull-right">
                      <a href="list_students.php?dept=<?php echo $_GET['dept']; ?>&class_id=<?php echo $_GET['class_id']; ?>" class="btn btn-secondary" style="margin-right: 8px; color: white;">Cancel</a>
                      <button name="editStudent_accPayable" type="submit" class="btn btn-primary">Update</button>
                </div>
                </div>
