        ...
        buttons: [
            {
                ...
                messageBottom: '<br /><table style="width: 100%;"><tr><th style="width: 40%; border: none;">Prepared by:</th><th style="width: 60%; border: none;">Checked by:</th></tr><tr><td style="border: none;"><p style="margin-bottom: 12px;">1st Grading: ________________________________</p><p style="margin-bottom: 12px;">2nd Grading: ________________________________</p><p style="margin-bottom: 12px;">3rd Grading: ________________________________</p><p style="margin-bottom: 12px;">4th Grading: ________________________________</p></td><td style="border: none;"><p style="margin-bottom: 12px;">1st Grading: ________________________________ Date: ___/___/________</p><p style="margin-bottom: 12px;">2nd Grading: ________________________________ Date: ___/___/________</p><p style="margin-bottom: 12px;">3rd Grading: ________________________________ Date: ___/___/________</p><p style="margin-bottom: 12px;">4th Grading: ________________________________ Date: ___/___/________</p></td></tr></table><hr /><center><?php echo strtoupper($schoolName); ?> | Office of the Registrar | <i class="fa fa-print"></i> <?php echo date('m/d/Y'); ?></center>'
            }
        ]
    } );
} );
                    ...
                    <table id="example" class="display" style="width:100%">
                          <thead>
                            <tr>
                              ...
                              <th>REMARKS</th>
                              <th>3<sup>RD</sup> GRADING</th>
                              <th>REMARKS</th>
                              <th>4<sup>TH</sup> GRADING</th>
                              <th>REMARKS</th>
                            </tr>
                          </thead>
                          <tbody>
