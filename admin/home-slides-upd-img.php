...
<html>
  ...
  <?php include('menu_sidebar.php'); ?>
    ...
    <!-- Breadcrumb-->
     ...
     $announce_query = $conn->query("SELECT title, img FROM tbl_home_slides WHERE slide_id='$_GET[slide_id]'") or die(mysql_error());
     ...
     ?>
      ...
      <div class="col-lg-12">
              ...
              <div class="card">
                ...
                <form action="save_update_imgs.php?slide_id=<?php echo $_GET['slide_id']; ?>" method="POST" class="form-horizontal" enctype="multipart/form-data" style="margin-top: 12px;"> 
                <div class="card-body">
                ...
                <div class="card-footer" style="text-align: right;">
                    ...
                    <button name="upd_slide_img" type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Update Image</button>
                </div>
