...
<html>
  ...
  <?php include('menu_sidebar.php'); ?>
    ...
    <?php include('navbar_header.php'); ?>
     ...
     $co_album_query = $conn->query("SELECT * FROM tbl_album_gallery WHERE pg_album_id='$_GET[pg_album_id]'") or die(mysql_error());
    ...
    <!-- Breadcrumb-->
      ...
      <div class="col-lg-12">
              ...
              <div class="card">
                ...
                <form action="save_update_imgs.php?pg_album_id=<?php echo $_GET['pg_album_id']; ?>" method="POST" class="form-horizontal" enctype="multipart/form-data" style="margin-top: 12px;"> 
                <div class="card-body">
                ...
                <div class="card-footer" style="text-align: right;">
                    <a href="camp-life-photo-gallery-cms.php" class="btn btn-secondary">Back to Photo Gallery Albums</a>
                    <button name="upd_img_pg_album" type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Update Image</button>
                </div>
                </form>
              </div>
      </div>
