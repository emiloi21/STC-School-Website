...
if(isset($_POST['update_pref']))
{
    ...
    if($_FILES['file']['name']=="")
    {
       ...
       $conn->query("UPDATE school_preferences SET deped_id='$upd_deped_id', region='$upd_region', division='$upd_division', schoolName='$upd_schoolName', address='$upd_address', emailAddress='$upd_emailAddress', contactNumber='$upd_contactNumber'");
    ...
    $conn->query("UPDATE school_preferences SET deped_id='$upd_deped_id', logo='$final_file', region='$upd_region', division='$upd_division', schoolName='$upd_schoolName', address='$upd_address', emailAddress='$upd_emailAddress', contactNumber='$upd_contactNumber'");
...
if(isset($_POST['activateSY']))
{
    ...
    $conn->query("UPDATE school_preferences SET activeSchoolYear='$activateSY'");
...
if(isset($_POST['activateSem']))
{
    ...
    $conn->query("UPDATE school_preferences SET activeSemester='$activateSemester'");
