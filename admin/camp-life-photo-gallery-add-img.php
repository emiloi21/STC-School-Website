<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        $uploadsDir = "camp-life/photo-gallery-album/";
            ...
            foreach($_FILES['fileUpload']['name'] as $id=>$val){
                ...
                if(in_array($fileType, $allowedFileType)){
                        if(move_uploaded_file($tempLocation, $targetFilePath)){
                            $sqlVal = "('".$_GET['pg_album_id']."', '".$fileName."', '".$uploadDate."')";
                        } else {
                            $response = array(
                                "status" => "alert-danger",
                ...
                if(!empty($sqlVal)) {
                    $insert = $conn->query("INSERT INTO tbl_album_gallery_img(pg_album_id, img, date_time)VALUES $sqlVal");
                    if($insert) {
                        $response = array(
      ...
      <div class="breadcrumb-holder">
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="camp-life-photo-gallery-img.php?pg_album_id=<?php echo $_GET['pg_album_id']; ?>"><?php echo strtoupper($club_org_album_row['title']); ?> Albums</a></li>
