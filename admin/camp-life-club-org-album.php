      ...
      <div class="breadcrumb-holder">
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><?php echo strtoupper($club_org_row['title']); ?></li>
          </ul>
        </div>
      </div>
      ...
      <div class="col-lg-12">
                  ...
                  <div id="addFacilities" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                    <div role="document" class="modal-dialog">
                      ...
                      <form action="camp-life-cms-save.php?club_org_id=<?php echo $_GET['club_org_id']; ?>&club_name=<?php echo strtoupper($club_org_row['title']); ?>; ?>" method="POST" class="form-horizontal" enctype="multipart/form-data" style="margin-top: 12px;"> 
                        ...
                        <div class="modal-footer">
                          ...
                          <button name="add_co_album" type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Save</button>
                        </div>
                        </form>
                      </div>
                    </div>
              ...
              <div class="card">
                ...
                <div class="card-header d-flex align-items-center">
                  <h4><a style="color: white !important;" data-toggle="modal" data-target="#addFacilities" href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a> <?php echo strtoupper($club_org_row['title']); ?>'S ALBUM</h4>
                </div>
                ...
                <div class="table-responsive" style="margin-top: 12px;">
                    <table id="" class="display" style="width:100%">
                      ...
                      <?php
                      $ctr=0;
                      $co_album_query = $conn->query("SELECT * FROM tbl_club_org_album WHERE club_org_id='$club_org_row[club_org_id]' ORDER BY album_id ASC") or die(mysql_error());
                      while ($co_album_row = $co_album_query->fetch()) 
                      {
                      
                      $ctr+=1;
                           
                      $album_id=$co_album_row['album_id'];
                      $club_org_id=$co_album_row['club_org_id'];
                      ...
                      ?>
                        ...
                        <tr>
                          ...
                          <td style="text-align: center;"><a href="camp-life-club-org-album-upd-img.php?club_org_id=<?php echo $club_org_id; ?>&album_id=<?php echo $album_id; ?>" title="Click to update image"><img src="<?php echo $co_album_row['cover_img']; ?>" style="width: 100px;" /></a></td>
                          <td style="text-align: center;"><?php echo $co_album_row['title']; ?><br /><small><?php echo $co_album_row['description']; ?></small></td>
                          
                          <td style="text-align: center;">
                          
                          <a style="color: white !important;" href="camp-life-club-org-album-img.php?club_org_id=<?php echo $club_org_id; ?>&album_id=<?php echo $album_id; ?>" class="btn btn-info btn-sm"><i class="fa fa-image"></i></a>
                          <a style="color: white !important;" data-toggle="modal" data-target="#editFacilities<?php echo $album_id; ?>" href="#" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                          <a style="color: white !important;" data-toggle="modal" data-target="#deleteFacilities<?php echo $album_id; ?>" href="#" class="btn btn-danger btn-sm"><i class="fa fa-times"></i></a>
                  ...
                  <!-- EDIT ALBUM Modal -->
                  <div id="editFacilities<?php echo $album_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                    <div role="document" class="modal-dialog">
                      <div class="modal-content">
                      ...
                      <input name="album_id" value="<?php echo $album_id; ?>" type="hidden" />
                        ...
                        <div class="modal-footer">
                          <a href="" data-dismiss="modal" class="btn btn-secondary">Cancel</a>
                          <button name="edit_co_album" type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Update</button>
                        </div>
                        </form>
                  ...
                  <!-- DELETE ALBUM Modal -->
                  <div id="deleteFacilities<?php echo $album_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                    <div role="document" class="modal-dialog">
                      <div class="modal-content">
                      ...
                      <input name="album_id" value="<?php echo $album_id; ?>" type="hidden" />
                        ...
                        <div class="modal-footer">
                          ...
                          <button name="del_co_album" type="submit" class="btn btn-danger">Yes</button>
                        </div>
                        </form>
                      </div>
                    </div>
