...
<html>
  ...
  <?php include('menu_sidebar.php'); ?>
    ...
    <!-- Breadcrumb-->
            ...
            <div class="col-lg-12 col-md-12">
              ...
              <div id="new-updates" class="card updates recent-updated">
                  ...
                  <a data-toggle="modal" data-target="#newTrans" href="#" class="btn btn-success btn-sm" style="color: white;"><i class="fa fa-refresh"></i></a>
                          ...
                          <div id="newTrans" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                            <div role="document" class="modal-dialog">
                              ...
                              <form action="save_cashiering_payment_val_books.php?receipt_num=<?php echo $_GET['receipt_num']; ?>&payment_type=<?php echo $_GET['payment_type']; ?>" method="POST">
                ...
                <div id="updates-boxJHS" role="tabpanel" class="collapse show">
                    ...
                    <div class="col-lg-12 col-md-12">
                    <?php if($_GET['payment_type']==='Book Payment Validation'){ ?>
                    ...
                    <?php
                    $payee_query = $conn->query("SELECT * FROM tbl_book_students WHERE reg_id='$_GET[reg_id]'") or die(mysql_error());
                    ...
                    <th></th>
                          ...
                          $tbl_book_payables_query = $conn->query("SELECT * FROM tbl_book_payables WHERE reg_id='$_GET[reg_id]' ORDER BY payable_id DESC") or die(mysql_error());
                          while ($tbl_book_payables_row = $tbl_book_payables_query->fetch()) 
                          {
                            
                            $payable_id=$tbl_book_payables_row['payable_id']; ?>
                            
                            <tr>
                             
                            <td><?php echo $tbl_book_payables_row['payment_term']; ?></td>
                            
                            <td>
                            <?php
                            $total_particulars_payable=$tbl_book_payables_row['total_amt']-$tbl_book_payables_row['total_amt_paid'];
                            $totalPayable+=$tbl_book_payables_row['total_amt']-$tbl_book_payables_row['total_amt_paid'];
                            
                            echo number_format($total_particulars_payable, 2);
                            ?>
                            </td>
                            
                            <td>
                            <?php
                            $tbl_student_payment_dummy_query = $conn->query("SELECT payment_id, amt_paid FROM tbl_student_payment_dummy WHERE receipt_num='$_GET[receipt_num]' AND category_id='$tbl_book_payables_row[payable_id]'") or die(mysql_error());
                            ...
                            <td style="width: 10px;">
                              <?php if($activeSchoolYear===$data_src_sy AND $total_particulars_payable>0){ ?>
                              <a style="color: white !important;" data-toggle="modal" data-target="#enter_payment<?php echo $payable_id; ?>" href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> PAYMENT</a>
                              
                               
                              <!-- enter payment Modal -->
                              <div id="enter_payment<?php echo $payable_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                                <div role="document" class="modal-dialog">
                                  <div class="modal-content">
                                  
                                    <form action="save_cashiering_payment_val_books.php?reg_id=<?php echo $_GET['reg_id']; ?>&assessment_id=<?php echo $_GET['assessment_id']; ?>&schoolYear=<?php echo $_GET['schoolYear']; ?>&semester=<?php echo $_GET['semester']; ?>&payment_type=<?php echo $_GET['payment_type']; ?>&receipt_num=<?php echo $_GET['receipt_num']; ?>&request_id=<?php echo $_GET['request_id']; ?>" method="POST">
                                    ...
                                    <h4><?php echo $tbl_book_payables_row['payment_term']; ?></h4>
                                    <table>
                                    <thead>
                                    <tr>
                                    ...
                                    <tbody>
                                    <tr>
                                    <td style="background-color: white; width: 50%;"><input value="<?php echo number_format($total_particulars_payable, 2); ?>" name="amt_payable" readonly="" class="form-control form-control-lg" /></td>
                                    ...
                                    <input name="amt_paid" value="<?php echo $tbl_student_payment_dummy_row['amt_paid']; ?>" type="number" min="0.50" max="<?php echo $total_particulars_payable+1; ?>" step="0.50" class="form-control form-control-lg" placeholder="Enter amount..." />
                                    </td>
                                    </tr>
                                    </tbody>
                                    </table>
                              ...
                              <div id="enter_payeeCash" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                                <div role="document" class="modal-dialog">
                                  ...
                                  <form action="save_cashiering_payment_val_books.php?reg_id=<?php echo $_GET['reg_id']; ?>&assessment_id=<?php echo $_GET['assessment_id']; ?>&schoolYear=<?php echo $_GET['schoolYear']; ?>&semester=<?php echo $_GET['semester']; ?>&payment_type=<?php echo $_GET['payment_type']; ?>&receipt_num=<?php echo $_GET['receipt_num']; ?>&request_id=<?php echo $_GET['request_id']; ?>" method="POST">
                                    ...
                                    <td style="background-color: white; width: 50%;">
                                    <input name="payee_cash" value="<?php echo $tbl_book_payables_row['total_amt_payable']; ?>" type="number" min="<?php echo $totalPayment; ?>" max="<?php echo $payValid_row['transAmt']; ?>" step="0.01" class="form-control form-control-lg" placeholder="Enter amount..." />
                                    </td>
                                    </tr>
                                    </tbody>
                                    </table>
      ...
      $tbl_book_payables_query=null;
      $tbl_book_payables_row=null;
