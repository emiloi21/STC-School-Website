             ...
             <!-- kinder 1     -->
              ...
              <div style="margin-top: 12px;"></div>
                ...
                <table id="" class="display" style="width:100%">
                      ...
                      $studData_query = $conn->query("SELECT * FROM students WHERE gradeLevel='$_GET[gradeLevel]' AND strand='$_GET[strand]' AND major='$_GET[major]' AND status='Paid'") or die(mysql_error());
