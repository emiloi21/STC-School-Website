          ...
          <div class="row">
            ...
            <!-- kinder 1  -->
              <div id="new-updates" class="card updates recent-updated">
                ...
                <a title="Nursery/Kinder student list" href="list_students.php?dept=Kinder&class_id=" class="tablinks active" style="font-weight: bolder;">Kinder</a>
                <?php }else{?>
                ...
                <a title="Elementary student list" href="list_students.php?dept=Elementary&class_id=" class="tablinks active" style="font-weight: bolder;">Elementary</a>
                <?php }else{?>
