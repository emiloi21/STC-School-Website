                ...
                <table id="" class="display" style="width:100%">
                      ...
                      $AR_discounts_query = $conn->query("SELECT * FROM tbl_assessments_discounts WHERE type='Receivable' AND reg_id='$studData_row[reg_id]'") or die(mysql_error());
                      ...
                      $catCtr+=1; 
                        ...
                        <a href="#" data-toggle="modal" data-target="#delete_receivable<?php echo $discount_id; ?>" class="btn btn-danger btn-sm" style="color: white;" title="Click to remove <?php echo $catCtr.'. '.$studData_row['lname'].', '.$studData_row['fname']; ?>'s profile..."><i class="fa fa-times"></i></a>
                        <?php } ?>
                        </td>
