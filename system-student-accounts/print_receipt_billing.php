...
<html>
<head>
<title>SRCS - Cashiering System</title>
...
<tr>
    ...
    <td style="width: 10px; border: none;">
     <img class="pull-right" width="45" height="45" src="../img/<?php echo $sf_row['logo'];?>" />
    </td>
...
<tr>
    ...
    <td style="border: none;">
    <center>
    <p style="margin: 2px; font-size: 14px;"><strong>OFFICIAL BILLING RECEIPT</strong></p>
...
<tr>
<td colspan="2" style="font-weight: lighter;">PAY TO: <strong style="font-size: 12px;"><?php echo $stud_row['fname'].' '.$stud_row['mname'].' '.$stud_row['lname'].' '.$stud_row['suffix']; ?></strong></td>
</tr>

<tr>
<td style="font-weight: lighter;">ASSESSMENT: <strong><?php echo $tbl_accounts_assessments_row['description']; ?></strong></td>
<td style="font-weight: lighter;">CLASS: <strong><?php if($stud_row['dept']==='SHS'){ echo strtoupper($stud_row['gradeLevel'].' - '.$stud_row['strand'].' - '.$stud_row['section']); }else{ echo strtoupper($stud_row['gradeLevel'].' - '.$stud_row['section']); } ?></strong></td>
</tr>
...
<td>
<p style="margin-left: 14px;"><strong style="text-decoration-line: underline;">LEOPOLDO TORNOS</strong><br />Cashier</p>
</td>
